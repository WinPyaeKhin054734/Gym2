  ...
  return (
    <div>
      <div className="min-h-[300px] flex flex-col justify-center py-5 bg-black px-5 md:px-10">
        ...
        <div className="flex justify-center items-center py-15 myAbban gap-5">
          {" "}
          <p className="font-bold text-3xl text-lime-400">
            Join Our Community
          </p>{" "}
          <p className="font-bold text-3xl text-lime-400">Join Our Community</p>{" "}
          <p className="font-bold text-3xl text-lime-400">Join Our Community</p>{" "}
          <p className="font-bold text-3xl text-lime-400">Join Our Community</p>{" "}
          <p className="font-bold text-3xl text-lime-400">Join Our Community</p>{" "}
          <p className="font-bold text-3xl text-lime-400">Join Our Community</p>{" "}
        ...
        <div className="flex justify-center items-center gap-5 flex-wrap">
          <img
            ...
            className="size-8 rounded-full cursor-pointer hover:scale-110 duration-500"
          />
          <img
