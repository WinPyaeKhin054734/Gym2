...
function Fith() {
  return (
    <div>
      <div className="grid lg:grid-cols-2 gap-10 py-10 px-5 lg:px-10 my-10 items-center">
        <FadeIn>
        ...
        <div className="aspect-square grid grid-cols-3 grid-rows-3 gap-5 group">
          ...
          <div className="col-span-2 row-span-2">
            <FadeIn className="size-full" delay={0.1}>
              <img
          ...
          <div className="row-span-2">
            <FadeIn className="size-full" delay={0.2}>
              <img
          ...
          <div className="row-span-1">
            <FadeIn className="size-full" delay={0.3}>
              <img
          ...
          <div className="row-span-1">
            <FadeIn className="size-full" delay={0.4}>
              <img
